...
$breadcrumb = [ 
    ...
    [ "name" => "$model->name_th" , "url" => route("suggestion_view_page" , ["id" => $model->topic_id]) ],
...
@endif
<a href="{{route("suggestion_view_page" , ["id" => $model->topic_id ])}}"><button class="btn btn-secondary"><i
            class="fas fa-undo"></i>
